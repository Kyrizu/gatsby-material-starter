      ...
      <Layout location={this.props.location}>
        <div className="policy-container">
          <Helmet>
            ...
            <p>Effective date: September 01, 2018</p>

            <p>KyrizuDev ("us", "we", or "our") operates the https://kyrizudev.com website (hereinafter referred to as the "Service").</p>

            <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. This Privacy Policy  for KyrizuDev is powered by <a href="https://privacypolicies.com/free-privacy-policy-generator/">PrivacyPolicies.com</a>.</p>
            ...
            <p>KyrizuDev uses the collected data for various purposes:</p>    
            <ul>
            ...
            <p>KyrizuDev will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

            <h2>Disclosure Of Data</h2>

            <h3>Legal Requirements</h3>
            <p>KyrizuDev may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of KyrizuDev</li>
            ...
            <ul>
                    <li>By email: kyrizudev@gmail.com</li>
